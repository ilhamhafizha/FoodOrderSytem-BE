package org.fos.foodordersystem.config;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationEntryPointConfig authenticationEntryPointConfig, AccessDeniedConfig accessDeniedConfig) throws Exception {
        http
